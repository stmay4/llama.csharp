...
добавление функций для получения эмбеддинга: функция получения текущего состояния: фичи: эмбеддинг обраотанной последовательности/текущее внутренее состояние модели
возможность отрисовывать траекторию движения мыслей модели

добавление мультимодальных функций: токенизация аудио и изображений, обработка полученных токенов отдельной функцией.
...
много кода закомментировано - это значит, что эти темы в процессе изучения
