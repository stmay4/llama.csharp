...
- Обновление до последних версий llama.cpp
...
Решаемые проблемы: дублирование моделей в памяти при загрузке одной и той же в разных программах, раздельная настройка параметров загрузки моделей в каждой программе, отсутствие прямой работы клиента с контекстом и пакетной обработкой у популярных аналогов 
