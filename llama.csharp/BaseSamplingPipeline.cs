...
namespace Llama.csharp
{
    public abstract class BaseSamplingPipeline: ISamplingPipeline
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract SafeLLamaSamplerChainHandle CreateChain();
        ...
        /// <inheritdoc />
        public virtual void Apply(LLamaTokenDataArray data)
        {
            _chain ??= CreateChain();
        ...
        public virtual void Apply(ref LLamaTokenDataArrayNative data)
        {
            _chain ??= CreateChain();
