...
namespace Llama.csharp.Extensions
{
    public static class IContextParamsExtensions
    {
        ...
        public static void ToLlamaContextParams(this IContextParams @params, out LLamaContextParams result)
        {
            ...
            result.flash_attn_type = @params.FlashAttention;
            ...
            result.cb_eval = nint.Zero;
            result.cb_eval_user_data = nint.Zero;

            result.type_k = @params.TypeK ?? GGMLType.GGML_TYPE_F16;
            result.type_v = @params.TypeV ?? GGMLType.GGML_TYPE_F16;

            result.abort_callback = nint.Zero;
            result.abort_callback_data = nint.Zero;
