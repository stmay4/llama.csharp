...
namespace Llama.csharp.Native
{
    ...
    public class LLamaBatch
    {
        ...
        public LLamaBatch()
        {
            ...
            _sequenceIdsPtrs = new nint[_sequenceIdCount.Length];
        ...
        /// <param name="logits">return logits or not for sampling in this batch evaluation</param>
